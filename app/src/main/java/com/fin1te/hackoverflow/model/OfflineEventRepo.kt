...
class OfflineEventRepo {
    ...
    val eventList: List<Event>
        get() {
            ...
            eventList.add(Event("16-03-2023", "Day 01", "11:30 - Attendance"))
            ...
            eventList.add(Event("16-03-2023", "Day 01", "22:00 - Networking"))
            ...
            eventList.add(Event("18-03-2023", "Day 03", "11:30 - Winner Announcement"))
            eventList.add(Event("18-03-2023", "Day 03", "11:30 - Closing Ceremony"))
            eventList.add(Event("18-03-2023", "Day 03", "13:30 - Job Fair"))

            eventList.add(Event("18-03-2023", "Conclusion", "Prizes for winners"))
